...
puppet resource service smbd ensure=masked enable=false
puppet resource service nmbd ensure=masked enable=false
puppet resource service winbind ensure=masked enable=false
